          ...
          <div className="col-span-1 md:col-span-4">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 text-slate-400 group">
                ...
                <a href="https://wa.me/6285756365672?text=Halo%20saya%20ingin%20tanya" target="_blank" rel="noopener noreferrer" className="hover:text-neon-cyan transition-colors">
                  Klik Disini
                </a>
              </li>
              <li className="flex items-start gap-3 text-slate-400">
